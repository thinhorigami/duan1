 ...
 * @author thinhorigami
 */
public class TestCustomer extends javax.swing.JFrame {
    
    private NhanVien nhan_vien;
    private JScrollPane table;
    /**
     * Creates new form TestCustomer
     */
    public TestCustomer() {
        initComponents();
        ...
        try {
            this.table = new JScrollPane(new MyTable(NhanVien.class, CustomerTableControl.class));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

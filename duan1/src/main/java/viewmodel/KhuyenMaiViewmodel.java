 ...
 * @author concu
 */
public class KhuyenMaiViewmodel implements Serializable{
    ...
    public KhuyenMaiViewmodel(String Id, String ma, String tenKM, String ngayBatDau, String ngayKetThuc, Integer muc_giam_gia, Boolean donVi, String moTa, int trangThai) {
        this.Id = Id;
        this.ma = ma;
        this.tenKM = tenKM;
    ...
    public KhuyenMaiViewmodel(String ma, String tenKM, String ngayBatDau, String ngayKetThuc, Integer muc_giam_gia, Boolean donVi, String moTa, int trangThai) {
        this.ma = ma;
        this.tenKM = tenKM;
        this.ngayBatDau = ngayBatDau;
        this.ngayKetThuc = ngayKetThuc;
    ...
    public KhuyenMaiViewmodel(String Id) {
        this.Id = Id;
    }
